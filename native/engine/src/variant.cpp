...
namespace {
    ...
    // Mini7 Xiangqi: dedicated 7x7 rules used by this project.
    // It keeps the minixiangqi board and piece movement, adds AXF chasing
    // adjudication, and makes the third consecutive rook-checking turn lose.
